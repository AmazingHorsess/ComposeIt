...
import com.amazinghorsess.task.R.string.task_detail_cd_icon_repeat_alarm
...
import com.libraries.core.extension.format
...
internal fun AlarmIntervalSelection(
    ...
    val (showDialog, setDialogValue) = remember {
    ...
    if (date != null) {
        ...
        TaskDetailSectionContent(
            ...
            contentDescription = task_detail_cd_icon_repeat_alarm,
        ) {
...
fun AlarmIntervalDialogPreview(){
    ComposeItTheme {
        AlarmIntervalDialog(showDialog = true, setDialogValue ={} ) {
